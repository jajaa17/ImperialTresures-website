  ...
  <div class="container col-xxl-8 px-4 py-5">
    <div class="row row1 flex-lg-row align-items-center g-5 py-5 ml-5">
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="<?= base_url('assets/images/logo.jpg') ?>" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes"
  ...
  <div class="container my-5">
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        <p class="lead">mperial Treasures was forged in 2023 by a band of Warhammer 40k enthusiasts who shared a fervor
          for all things epic and grand. We started as a humble online store, offering bespoke Warhammer accessories.
          Now, we've evolved into a trusted name, delivering a vast array of products to fans across the globe.</p>
      </div>
